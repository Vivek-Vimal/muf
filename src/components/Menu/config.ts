    ...
    items: [
      {
        label: 'PancakeSwap',
        href: '',
        //  'https://pancakeswap.finance/info/pool/0x90ebf5bf9e0486893debc85dcf164d1ddc107e0c', // 'https://pancakeswap.info/token/0xF952Fc3ca7325Cc27D15885d37117676d25BfdA6',
      },
      // {
      //   label: 'CoinGecko',
      ...
      // },
      {
        label: 'CoinMooner',
        href: '',
        //  'https://coinmooner.com/coin/6924%F0%9F%9A%80',
      },
      {
        label: 'CoinMarketCap',
        href:  '',
        // 'https://coinmarketcap.com/currencies/muftswap/', // 'https://coinmarketcap.com/currencies/goose-finance/',
      },
      // {
      //   label: 'AstroTools',
  ...
  },
  {
    ...
    items: [
      ...
      // },
      {
        label: 'Docs',
        href: '',
        //  'https://docs.manutdfantoken.app/', // 'https://goosedefi.gitbook.io/goose-finance/',
      },
      // {
      //   label: 'Blog',
